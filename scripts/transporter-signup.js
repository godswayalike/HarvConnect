document.addEventListener("DOMContentLoaded", () => {
  ...
  form.addEventListener("submit", async (e) => {
    ...
    const selectedRole = (
      localStorage.getItem("harvconnect_user_role") || "Transport"
    ).trim();
      ...
      selectedRole === "Farmer"
        ...
        : selectedRole === "Buyer"
          ...
          : selectedRole === "Transport" ||
              selectedRole === "Transport Provider"
            ? "TRANSPORT"
            : selectedRole.toUpperCase();

    // Collect the registration fields expected by the auth endpoint.
    const formData = {
      ...
      role: normalizedRole,
      vehicleType:
        document.getElementById("produceType")?.value.trim() || "OTHER",
      capacity: 1,
    };
